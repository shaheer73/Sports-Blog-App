...
const Comments = ({ comment, setComment, addComment, comments, isPostingComment }: IProps) => {
  ...
  return (
    <div className='mt-10 border-t-2 border-gray-200 pt-4 px-10 bg-[#F8F8F8] border-b-2 lg:pb-0 pb-[100px]'>
        <div className='overflow-scroll lg:h-[350px]'>
            {comments?.length ? (
        ...
        {userProfile && (
            <div className='relative pb-6 px-2 md:px-10'>
